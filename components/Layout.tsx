...
export default function Layout({ children }: { children: React.ReactNode }) {
    return (
        <div className='bg-black flex flex-col relative h-svh max-h-svh w-svw max-w-svw overflow-x-hidden' suppressHydrationWarning>
            <div className="flex flex-row justify-center gap-4">
                {/* left column */}
                <div className="md:flex hidden flex-col p-4 mr-14 justify-between sticky items-end gap-4 w-1/3 min-h-screen">
                    <div className="flex flex-col items-start gap-6">
                        ...
                        <Button size="defaultRound" variant="ghost" className='flex p-2'>
                    ...
                    <div className="flex flex-col items-start gap-6 w-42 mr-12">
                        <Button size="defaultRound" variant="ghost" className="flex flex-col w-40 items-start py-8 px-2">
